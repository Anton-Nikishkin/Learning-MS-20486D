...
namespace PollBall.Services
{
    public class PollResultsService : IPollResultsService
    {
        ...
        public PollResultsService() => _selectionVotes = new Dictionary<SelectedGame, int>();
        ...
        public SortedDictionary<SelectedGame, int> GetVoteResult() => new SortedDictionary<SelectedGame, int>(_selectionVotes);
    }
}
